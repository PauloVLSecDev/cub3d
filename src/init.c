...
void	load_textures(t_game *game)
{
	game->textures[0].img = mlx_xpm_file_to_image(game->mlx,
			game->map_data.texture_no, &game->textures[0].width,
	...
	game->textures[1].img = mlx_xpm_file_to_image(game->mlx,
			game->map_data.texture_so, &game->textures[1].width,
	...
	game->textures[2].img = mlx_xpm_file_to_image(game->mlx,
			game->map_data.texture_we, &game->textures[2].width,
	...
	game->textures[3].img = mlx_xpm_file_to_image(game->mlx,
			game->map_data.texture_ea, &game->textures[3].width,
...
void	init_game(t_game *game)
{
	...
	// game->map_map = game->map_data.largest_line;
